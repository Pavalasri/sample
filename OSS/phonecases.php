...
<body>
  ...
  <div class="back">
    <div class="text">
      <h1>Phone Cases</h1>
      <p>Carry a masterpiece with you. Our phone backcovers feature exclusive artwork from talented artists, 
        transforming your device into a canvas of creativity. 
        Protect your phone with a unique design that showcases your appreciation for art</p>
    </div>
    <img src="home_phonecase/backcover3.png" style="width:40%">
  </div>
  ...
  <div class="categories">
    <div class="container">
      <div class="row">
        <div class="col-lg-4">
          <div class="img-hv" data-toggle="modal" data-target="#productModal" data-title="Asthetic Hands Phone Case" data-price="$4.00" data-image="home_phonecase/case1.jpg">
            <img src="home_phonecase/case1.jpg" width="300" height="300">
          </div>
          <h4>Aesthetic Hands Phonecase</h4>
        ...
        <div class="col-lg-4">
          <div class="img-hv" data-toggle="modal" data-target="#productModal" data-title="Graffiti Phonecase" data-price="$30.00" data-image="home_phonecase/case2.jpg">
            <img src="home_phonecase/case2.jpg" width="300" height="300">
          </div>
          <h4>Aesthetic Beach vibe Phonecase</h4>
          <i class="fa fa-star fill-st"></i>
          <i class="fa fa-star fill-st"></i>
          <i class="fa fa-star fill-st"></i>
          <i class="fa fa-star fill-st"></i>
        ...
        <div class="col-lg-4">
          <div class="img-hv" data-toggle="modal" data-target="#productModal" data-title="Graffiti Phonecase" data-price="$30.00" data-image="home_phonecase/case3.jpg">
            <img src="home_phonecase/case3.jpg" width="300" height="300">
          </div>
          <h4>Art Aesthetic David Mona Lisa Phonecase</h4>
          <i class="fa fa-star fill-st"></i>
          <i class="fa fa-star fill-st"></i>
          <i class="fa fa-star fill-st"></i>
          <i class="fa-regular fa-star"></i>
      ...
      <div class="row">
        <div class="col-lg-4">
          <div class="img-hv" data-toggle="modal" data-target="#productModal" data-title="Graffiti Phonecase" data-price="$30.00" data-image="home_phonecase/case4.jpg">
            <img src="home_phonecase/case4.jpg" width="300" height="300">
          </div>
          <h4>Abstract Doodle Art Printed Glass Case</h4>
          <i class="fa fa-star fill-st"></i>
          <i class="fa fa-star fill-st"></i>
          <i class="fa-regular fa-star"></i>
          <i class="fa-regular fa-star"></i>
        ...
        <div class="col-lg-4">
          <div class="img-hv" data-toggle="modal" data-target="#productModal" data-title="Graffiti Phonecase" data-price="$30.00" data-image="home_phonecase/case5.jpg">
            <img src="home_phonecase/case5.jpg" width="300" height="300">
          </div>
          <h4>Cute Animals Doodle Phonecase</h4>
          <i class="fa fa-star fill-st"></i>
          <i class="fa fa-star fill-st"></i>
          <i class="fa fa-star fill-st"></i>
          <i class="fa-regular fa-star"></i>
        ...
        <div class="col-lg-4">
          <div class="img-hv" data-toggle="modal" data-target="#productModal" data-title="Graffiti Phonecase" data-price="$30.00" data-image="home_phonecase/case7.jpg">
            <img src="home_phonecase/case7.jpg" width="250" height="300">
          </div>
          <h4>Mid Century Modern Geometric Phonecase</h4>
          <i class="fa fa-star fill-st"></i>
          <i class="fa fa-star fill-st"></i>
          <i class="fa fa-star fill-st"></i>
          <i class="fa-regular fa-star"></i>
      ...
      <div class="row">
        <div class="col-lg-4">
          <div class="img-hv" data-toggle="modal" data-target="#productModal" data-title="Graffiti Phonecase" data-price="$30.00" data-image="home_phonecase/case9.jpg">
            <img src="home_phonecase/case11.jpg" width="300" height="300">
          </div>
          <h4>Aesthetc Collage Lifestyle Art PhoneCase</h4>
          <i class="fa fa-star fill-st"></i>
          <i class="fa fa-star fill-st"></i>
          <i class="fa fa-star fill-st"></i>
          <i class="fa fa-star fill-st"></i>
        ...
        <div class="col-lg-4">
          <div class="img-hv" data-toggle="modal" data-target="#productModal" data-title="Graffiti Phonecase" data-price="$30.00" data-image="home_phonecase/case9.jpg">
            <img src="home_phonecase/case9.jpg" width="300" height="300">
          </div>
          <h4>Floating Floral Print Phonecase</h4>
          <i class="fa fa-star fill-st"></i>
          <i class="fa fa-star fill-st"></i>
          <i class="fa fa-star fill-st"></i>
          <i class="fa-regular fa-star"></i>
        ...
        <div class="col-lg-4">
          <div class="img-hv" data-toggle="modal" data-target="#productModal" data-title="Graffiti Phonecase" data-price="$30.00" data-image="home_phonecase/case10.jpg">
            <img src="home_phonecase/case10.jpg" width="250" height="300">
          </div>
          <h4>Pink Warped Happy Face Holo Shock Phonecase</h4>
          <i class="fa fa-star fill-st"></i>
          <i class="fa fa-star fill-st"></i>
          <i class="fa fa-star fill-st"></i>
          <i class="fa-regular fa-star"></i>
