...
<body>
    <nav>
        <img src="artt.png">
        <a href="../main.html"><button><i class="fa-solid fa-backward"></i>   Back to Home</button></a>
    </nav>
    <div class="header">
        <h1>Join Us</h1>
    </div>
    <div class="container">
        <div class="box" id="artist-box">
            <img src="artist.webp" height="130" width="120">
            <p><a id="artist-signup" href="#">Artist Signup</a></p>
        </div>
